...
import edu.pucmm.eict.vaadin14.views.otherComponents.OtherComponents;
import edu.pucmm.eict.vaadin14.views.otherComponents.Yelson;
import edu.pucmm.eict.vaadin14.views.Other.*;
...
public class MainView extends AppLayout {
    ...
    private static Tab[] getAvailableTabs() {
        ...
        //tabs.add(createTab("Departmant", DepartmentView.class));
        tabs.add(createTab("Other components", OtherComponents.class));
        tabs.add(createTab("Yelson", Yelson.class));
        tabs.add(createTab("Other", Other.class));
